...
class _CalenderScreenState extends State<CalenderScreen> {
  ...
  Widget build(BuildContext context) {
    context.watch<CalenderProvider>().getCategory();
    ...
    return Consumer<DarkThemeProvider>(builder: (context, prov1, _) {
      return Consumer<CalenderProvider>(builder: (context, prov, _) {
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            onChanged: ((value) {
                              setState(() {
                                filterData = Provider.of<CalenderProvider>(
                                        context,
                                        listen: false)
                                    .todoList
                                    .where(
          ...
          SlidableAction(
            ...
            onPressed: (val) {
              deleteProvider.addDeleteItem(DeleteModel(
                ...
                todoName: calenderProvider.calenderBox,
              ));
              log('data added in Delete model');
              calenderProvider.deleteTODOItem(indexValue);
            },
