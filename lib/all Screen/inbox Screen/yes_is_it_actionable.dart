...
import 'noWhattheNextAction.dart';
import 'yes_What’s_the_Next_Action.dart';

class Yesisitactionable extends StatefulWidget {
  InboxModel holeData;
  int indexvalue;
  Yesisitactionable(
  ...
  @override
  State<Yesisitactionable> createState() => _YesisitactionableState();
}

class _YesisitactionableState extends State<Yesisitactionable> {
