...
import 'n0Isitforme.dart';
import 'yes_Is_it_for_me.dart';

class NoLessThan2Mintes extends StatefulWidget {
  InboxModel holeData;
  int indexvalue;
  NoLessThan2Mintes({
    Key? key,
  ...
  @override
  State<NoLessThan2Mintes> createState() => _NoLessThan2MintesState();
}

class _NoLessThan2MintesState extends State<NoLessThan2Mintes> {
