...
import 'no_less_than_2_minute.dart';
import 'yesLesThan2Min.dart';

class YesWhattheNextAction extends StatefulWidget {
  InboxModel holeData;
  int indexvalue;
  YesWhattheNextAction(
      {Key? key, required this.holeData, required this.indexvalue})
      : super(key: key);

  @override
  State<YesWhattheNextAction> createState() => _YesWhattheNextActionState();
}

class _YesWhattheNextActionState extends State<YesWhattheNextAction> {
