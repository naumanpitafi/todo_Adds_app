...
class NoIsItForMe extends StatefulWidget {
  InboxModel wholedata;
  int indexvalue;
  NoIsItForMe({Key? key, required this.wholedata, required this.indexvalue})
      : super(key: key);

  @override
  State<NoIsItForMe> createState() => _NoIsItForMeState();
}

class _NoIsItForMeState extends State<NoIsItForMe> {
