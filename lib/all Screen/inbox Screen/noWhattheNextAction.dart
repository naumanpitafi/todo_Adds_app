...
class NoWhattheNextAction extends StatefulWidget {
  InboxModel holeData;
  NoWhattheNextAction({Key? key, required this.holeData}) : super(key: key);

  @override
  State<NoWhattheNextAction> createState() => _NoWhattheNextActionState();
}

class _NoWhattheNextActionState extends State<NoWhattheNextAction> {
