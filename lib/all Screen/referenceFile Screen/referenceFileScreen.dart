...
class ReferenceFileScreen extends StatefulWidget {
  const ReferenceFileScreen({Key? key}) : super(key: key);

  @override
  State<ReferenceFileScreen> createState() => _ReferenceFileScreenState();
}

class _ReferenceFileScreenState extends State<ReferenceFileScreen> {
  TextEditingController searchController = TextEditingController();
  List filterData = [];
  ReferenceProvider referenceProvider = ReferenceProvider();
  InboxProvider inboxProvidr = InboxProvider();
  ...
  Widget build(BuildContext context) {
    context.watch<ReferenceProvider>().getCategory();
    ...
    return Consumer<DarkThemeProvider>(builder: (context, prov1, _) {
      return Consumer<ReferenceProvider>(builder: (context, prov, _) {
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            onChanged: ((value) {
                              setState(() {
                                filterData = Provider.of<ReferenceProvider>(
                                        context,
                                        listen: false)
                                    .todoList
                                    .where(
      ...
      endActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            // onPressed: doNothing,
            onPressed: (val) {
              inboxProvidr.deleteTODOItem(indexValue);
