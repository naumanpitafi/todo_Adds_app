...
class _ProjectListState extends State<ProjectList> {
  ...
  List filterData = [];
  ProjectListProvider projectProvider = ProjectListProvider();
  ...
  Widget build(BuildContext context) {
    context.watch<ProjectListProvider>().getCategory();
    ...
    return Consumer<DarkThemeProvider>(builder: (context, prov1, _) {
      return Consumer<ProjectListProvider>(builder: (context, prov, _) {
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            onChanged: ((value) {
                              setState(() {
                                filterData = Provider.of<ProjectListProvider>(
                                        context,
                                        listen: false)
                                    .todoList
                                    .where(
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            colorPicker(context);
                            // prov.addCategory(CategoryModel(
                                ...
                                ? todoCat.status == 'finish'
                                    ? Row(
                                        children: [
                                          ...
                                          containerData(todoCat.text.toString(),
                                              todoCat.dateTime, todoCat, i)
                                        ],
                                      )
                                    : const SizedBox()
                                : const SizedBox();
  ...
  Widget categoryWidget(title1, colorvlue, intValue) {
    return Container(
      width: 110.w,
      height: 35.h,
      decoration: BoxDecoration(
        ...
        color: Color(int.parse(colorvlue)),
          ...
          SlidableAction(
            ...
            onPressed: (val) {
              deleteProvider.addDeleteItem(DeleteModel(
                ...
                todoName: projectProvider.projectListBox,
              ));
              log('data added in Delete model');
              projectProvider.deleteTODOItem(indexValue);
            },
