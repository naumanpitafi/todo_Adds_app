...
class SoomeDayMayBe extends StatefulWidget {
  const SoomeDayMayBe({Key? key}) : super(key: key);

  @override
  State<SoomeDayMayBe> createState() => _SoomeDayMayBeState();
}

class _SoomeDayMayBeState extends State<SoomeDayMayBe> {
  ...
  Widget build(BuildContext context) {
    context.watch<SomeDayMaybeProvider>().getCategory();
    ...
    return Consumer<DarkThemeProvider>(builder: (context, prov1, _) {
      return Consumer<SomeDayMaybeProvider>(builder: (context, prov, _) {
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            onChanged: ((value) {
                              setState(() {
                                filterData = Provider.of<SomeDayMaybeProvider>(
                                        context,
                                        listen: false)
                                    .todoList
                                    .where(
        ...
        children: [
          SlidableAction(
            ...
            onPressed: (val) {
              ...
              //   todoName: referenceProvider.referenceBox,
              // ));
              // log('data added in Delete model');
              // referenceProvider.deleteTODOItem(indexValue);
            },
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          width: 3,
          color:
              selectedCateIndex == intValue ? Colors.black : Colors.transparent,
        ),
  ...
  Widget containerData(textValue, dateTimevalue, holedata, indexValue) {
    return Slidable(
      endActionPane: ActionPane(
        motion: const ScrollMotion(),
        children: [
          SlidableAction(
            ...
            onPressed: (val) {
              deleteProvider.addDeleteItem(DeleteModel(
                ...
                todotext: holedata.text,
                dateTime: holedata.dateTime,
                todoName: somedayMayBeProvider.somedayMybeBox,
              ));
              log('data added in Delete model');
              somedayMayBeProvider.deleteTODOItem(indexValue);
            },
            backgroundColor: AppColors.reedColor,
            foregroundColor: Colors.white,
            label: 'Delete',
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      if (catName.text.isNotEmpty) {
                        ...
                        somedayMayBeProvider.addCategory(
                        ...
                        InkWell(
                          onTap: () {
                            if (todoTextController.text.isNotEmpty &&
                              ...
                              somedayMayBeProvider.addTODOItem(
                                TodoModel(
